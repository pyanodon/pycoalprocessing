...
RECIPE {
    ...
    main_product = 'coal',
    icon = '__pycoalprocessinggraphics__/graphics/icons/coal-fawogae.png',
    icon_size = 32,
    subgroup = 'py-items-hpf',
    order = 'g'
}:add_unlock('coal-processing-1')
...
RECIPE {
    ...
    subgroup = 'py-items',
    order = 'c',
    crafting_machine_tint = {primary = defines.color.black, secondary = defines.color.white}
...
RECIPE {
    ...
    icon = "__pycoalprocessinggraphics__/graphics/icons/oleo-solid-fuel.png",
    icon_size = 32,
    subgroup = "py-fluid-handling",
    order = "c"
}:add_unlock("coal-processing-3")
