...
for _, recipe in pairs(table.filter(data.raw.recipe, function(v) return v.category == "smelting" and #v.ingredients == 1 end)) do
    local ing1 = recipe.ingredients[1].name and recipe.ingredients[1] or {type="item", name=recipe.ingredients[1][1], amount=recipe.ingredients[1][2] * 5}
    local res
