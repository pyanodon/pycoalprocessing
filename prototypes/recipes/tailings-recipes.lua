...
tailings_borax_niobium.icons[ #tailings_borax_niobium.icons+1 ] = {
    icon =
    "__pycoalprocessinggraphics__/graphics/icons/ores/borax-niobium.png",
    icon_size = 32
}
...
tailings_copper_iron.icons[ #tailings_copper_iron.icons+1 ] = {
    icon =
    "__pycoalprocessinggraphics__/graphics/icons/ores/copper-iron.png",
    icon_size = 32
}
