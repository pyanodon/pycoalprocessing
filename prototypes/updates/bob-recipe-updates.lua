...
bobmods.lib.recipe.replace_ingredient("cooling_tower_mk01", "pipe", "copper-pipe")
bobmods.lib.recipe.replace_ingredient("cooling_tower_mk01", "iron-gear-wheel", "brass-gear-wheel")
bobmods.lib.recipe.replace_ingredient("cooling_tower_mk01", "iron-plate", "brass-plate")
