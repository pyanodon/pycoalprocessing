...
TECHNOLOGY("physical-projectile-damage-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("physical-projectile-damage-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("stronger-explosives-4"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("stronger-explosives-5"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("stronger-explosives-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("stronger-explosives-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("refined-flammables-4"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("refined-flammables-5"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("refined-flammables-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("refined-flammables-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("energy-weapons-damage-5"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("energy-weapons-damage-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("energy-weapons-damage-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("weapon-shooting-speed-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("laser-shooting-speed-5"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("laser-shooting-speed-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("laser-shooting-speed-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("artillery-shell-range-1"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("artillery-shell-speed-1"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("follower-robot-count-5"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("follower-robot-count-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("follower-robot-count-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("inserter-capacity-bonus-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("space-science-pack"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("military-4"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("uranium-ammo"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("atomic-bomb"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("braking-force-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("braking-force-7"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("power-armor-mk2"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("rocket-control-unit"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("rocket-silo"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("research-speed-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("logistic-system"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("worker-robots-speed-5"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("worker-robots-speed-6"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("worker-robots-storage-3"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("personal-roboport-mk2-equipment"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("mining-productivity-3"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("mining-productivity-4"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("artillery"):add_pack("military-science-pack"):add_pack("production-science-pack")
TECHNOLOGY("spidertron"):add_pack("military-science-pack"):add_pack("production-science-pack")
