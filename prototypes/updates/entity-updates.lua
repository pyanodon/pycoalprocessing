...
data.raw[ "assembling-machine" ][ "assembling-machine-1" ].fluid_boxes = data.raw[ "assembling-machine" ]
    [ "assembling-machine-2" ].fluid_boxes
...
data.raw.locomotive.locomotive.energy_source.burnt_inventory_size = data.raw.locomotive.locomotive.energy_source
    .fuel_inventory_size
