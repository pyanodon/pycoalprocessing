...
local cooling_water ={
  ...
  energy_required = 1,
  ingredients ={
    {type="fluid", name="water", amount=5, temperature=70},
  },
  results={
...
data:extend({
  zinc_chloride, tar_carbon, active_carbon, iron_oxide, cooling_water, salt_ex, extract_sulfur, ref_to_light_oil, ref_to_petroleum_gas,
})
