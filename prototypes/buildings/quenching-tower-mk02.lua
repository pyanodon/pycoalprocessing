...
ITEM {
    type = "item",
    name = "quenching-tower-mk02",
    icon = "__pycoalprocessinggraphics__/graphics/icons/quenching-tower-mk02.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "quenching-tower-mk02"},
    ...
    energy_usage = "400kW",
    animation = {
        filename = "__pycoalprocessinggraphics__/graphics/entity/quenching-tower/quenching-tower-anim-mk02.png",
        width = 232,
        height = 252,
        frame_count = 60,
        line_length = 8,
    ...
    next_upgrade = 'quenching-tower-mk03'
}
