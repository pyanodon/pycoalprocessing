...
ITEM {
    type = "item",
    name = "chemical-plant-mk04",
    icon = "__pycoalprocessinggraphics__/graphics/icons/chemical-plant-mk04.png",
    icon_size = 64,
    flags = {},
    subgroup = "py-cp-buildings-mk04",
    order = "d",
    place_result = "chemical-plant-mk04",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 1, result = "chemical-plant-mk04"},
