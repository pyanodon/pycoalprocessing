...
ITEM {
    type = "item",
    name = "washer-mk03",
    icon = "__pycoalprocessinggraphics__/graphics/icons/washer-mk03.png",
    icon_size = 64,
    flags = {},
    subgroup = "py-cp-buildings-mk03",
    order = "z2",
    place_result = "washer-mk03",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 1, result = "washer-mk03"},
    ...
    energy_usage = "300kW",
    animation = {
        filename = "__pycoalprocessinggraphics__/graphics/entity/washer/washer-mk03.png",
        width = 204,
        height = 204,
        frame_count = 80,
        line_length = 10,
