...
ITEM {
    type = "item",
    name = "chemical-plant-mk03",
    icon = "__pycoalprocessinggraphics__/graphics/icons/chemical-plant-mk03.png",
    icon_size = 64,
    flags = {},
    subgroup = "py-cp-buildings-mk03",
    order = "d",
    place_result = "chemical-plant-mk03",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 1, result = "chemical-plant-mk03"},
