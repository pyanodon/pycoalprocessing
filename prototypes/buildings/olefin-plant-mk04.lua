...
ITEM {
    type = "item",
    name = "olefin-plant-mk04",
    icon = "__pycoalprocessinggraphics__/graphics/icons/olefin-plant-mk04.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "olefin-plant-mk04"},
    ...
    energy_usage = "650kW",
    animation = {
        filename = "__pycoalprocessinggraphics__/graphics/entity/olefin-plant/olefin-off-mk04.png",
        width = 274,
        height = 302,
        frame_count = 1,
        --animation_speed = 0.5,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pycoalprocessinggraphics__/graphics/entity/olefin-plant/anim-mk04.png",
                frame_count = 84,
                line_length = 8,
                width = 256,
                height = 139,
