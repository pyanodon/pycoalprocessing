...
ITEM {
    type = "item",
    name = "automated-factory-mk03",
    icon = "__pycoalprocessinggraphics__/graphics/icons/automated-factory-mk03.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pycoalprocessinggraphics__/graphics/entity/automated-factory/mk03-left.png",
                width = 128,
                height = 280,
                line_length = 16,
                frame_count = 101,
            ...
            {
                filename = "__pycoalprocessinggraphics__/graphics/entity/automated-factory/mk03-right.png",
                width = 116,
                height = 280,
                line_length = 16,
                frame_count = 101,
