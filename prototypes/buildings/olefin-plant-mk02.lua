...
ITEM {
    type = "item",
    name = "olefin-plant-mk02",
    icon = "__pycoalprocessing__/graphics/icons/olefin-plant-mk02.png",
    icon_size = 32,
...
ENTITY {
    ...
    minable = {mining_time = 1, result = "olefin-plant-mk02"},
    ...
    ingredient_count = 5,
    animation = {
        filename = "__pycoalprocessing__/graphics/entity/olefin-plant/olefin-off-mk02.png",
        width = 205,
        height = 224,
        frame_count = 1,
        --animation_speed = 0.5,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pycoalprocessing__/graphics/entity/olefin-plant/olefin-plant-mk02.png",
                frame_count = 69,
                line_length = 9,
                width = 205,
                height = 224,
