        ...
        fluid_boxes = {
            {
                ...
                volume = 1000,
                base_level = -1,
                pipe_connections = {{flow_direction = 'input', position = {0.5, 2.8}, direction = defines.direction.south}}
            },
            {
                ...
                volume = 100,
                pipe_connections = {{flow_direction = 'output', position = {0.5, -2.8}, direction = defines.direction.north}}
            },
