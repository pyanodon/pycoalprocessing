...
RECIPE({
    ...
    energy_required = 2,
}):add_ingredient({ type = "item", name = "small-parts-01", amount = 10 }):add_ingredient({ type = "item", name = "belt", amount = 3 })
    :add_ingredient({ type = "item", name = "engine-unit", amount = 3 }):add_ingredient({ type = "fluid", name = "lubricant", amount = 200 })
    :add_ingredient({ type = "item", name = "nbfe-alloy", amount = 10 })
