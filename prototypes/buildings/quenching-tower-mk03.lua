...
ITEM {
    type = "item",
    name = "quenching-tower-mk03",
    icon = "__pycoalprocessinggraphics__/graphics/icons/quenching-tower-mk03.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "quenching-tower-mk03"},
    ...
    energy_usage = "500kW",
    animation = {
        filename = "__pycoalprocessinggraphics__/graphics/entity/quenching-tower/quenching-tower-anim-mk03.png",
        width = 232,
        height = 252,
        frame_count = 60,
        line_length = 8,
    ...
    next_upgrade = 'quenching-tower-mk04'
}
