...
ITEM {
    type = "item",
    name = "hpf-mk04",
    icon = "__pycoalprocessinggraphics__/graphics/icons/hpf-mk04.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "hpf-mk04"},
    ...
    animation = {
        priority = "high",
        filename = "__pycoalprocessinggraphics__/graphics/entity/hpf/hpf-off-mk04.png",
        width = 167,
        height = 173,
        frame_count = 1,
        --animation_speed = 0.5,
    ...
    working_visualisations = {
        {
            ...
            east_position = {0.1, 0},
            animation = {
                filename = "__pycoalprocessinggraphics__/graphics/entity/hpf/hpf-anim-mk04.png",
                priority = "medium",
                frame_count = 50,
                line_length = 10,
                width = 167,
        ...
        },
        {
            ...
            animation = {
                filename = "__pycoalprocessinggraphics__/graphics/entity/hpf/smoke-anim-mk04.png",
                priority = "extra-high",
                frame_count = 80,
                line_length = 20,
                width = 79,
