...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pycoalprocessing__/graphics/entity/distilator/distilator-mk03-a.png",
                width = 96,
				height = 358,
                line_length = 20,
                frame_count = 100,
			...
			{
               filename = "__pycoalprocessing__/graphics/entity/distilator/distilator-mk03-b.png",
               width = 96,
			   height = 358,
               line_length = 20,
               frame_count = 100,
			...
			{
               filename = "__pycoalprocessing__/graphics/entity/distilator/distilator-mk03-c.png",
               width = 96,
			   height = 358,
               line_length = 20,
               frame_count = 100,
