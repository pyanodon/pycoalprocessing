...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "glassworks-mk01"},
    ...
    fluid_boxes = {
        ...
        },
        {
            ...
            base_area = 10,
            base_level = -1,
            pipe_connections = {{type = "input", position = {-4.0, 0}}}
        },
        {
            ...
            base_area = 10,
            base_level = 1,
            pipe_connections = {{type = "output", position = {4.0, 0}}}
        },
