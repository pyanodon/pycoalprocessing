	...
	elseif settings.startup['module-slot-change'].value == 'plus-one-per' then
		...
		if string.match(mach, 'mk01') ~= nil then
			...
			elseif data.raw.furnace[mach] ~= nil then
				...
				data.rawfurnace[mach].module_specification.module_slots = 1
		...
		if string.match(mach, 'mk02') ~= nil then
			...
			elseif data.raw.furnace[mach] ~= nil then
				...
				data.rawfurnace[mach].module_specification.module_slots = 2
		...
		if string.match(mach, 'mk03') ~= nil then
			...
			elseif data.raw.furnace[mach] ~= nil then
				...
				data.rawfurnace[mach].module_specification.module_slots = 3
		...
		if string.match(mach, 'mk04') ~= nil then
			...
			elseif data.raw.furnace[mach] ~= nil then
				...
				data.rawfurnace[mach].module_specification.module_slots = 4
	...
	elseif settings.startup['module-slot-change'].value == 'plus-two-per' then
		...
		if string.match(mach, 'mk03') ~= nil then
			...
			elseif data.raw.furnace[mach] ~= nil then
				...
				data.rawfurnace[mach].module_specification.module_slots = 6
		...
		if string.match(mach, 'mk04') ~= nil then
			...
			elseif data.raw.furnace[mach] ~= nil then
				...
				data.rawfurnace[mach].module_specification.module_slots = 8
