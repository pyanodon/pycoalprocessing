    ...
    milestones_presets = function()
        local preset = {
            ...
            milestones = {
                ...
                {type="item",       name="effectivity-module",            quantity=1},
                {type="item",       name="effectivity-module-2",          quantity=1,  hidden=true},
                {type="item",       name="effectivity-module-3",          quantity=1,  hidden=true},
